...
INSERT INTO `weapons_general` VALUES ('8', 'katana', 'blade', '5', 'A daintier alternative to the machete. Slice and dice your zombies ninja style!', 'sharpening');
INSERT INTO `weapons_general` VALUES ('3', 'chainsaw', 'blade', '3', 'An unwieldy but effective means of tearing up the undead. Also potentially useful for building shelters.', 'greasing, refueling, replacing chains');
INSERT INTO `weapons_general` VALUES ('7', 'axe', 'blade', '8', 'For chopping and lopping zombie bits. A generally handy survival tool.', 'sharpening');
INSERT INTO `weapons_general` VALUES ('9', 'grenade', 'explosive', '1', 'Fire in the hole! Just pull the pin and you\'re done!', 'none');
INSERT INTO `weapons_general` VALUES ('10', 'molotov cocktail', 'explosive', '1', 'Do you like your zombies well-done? Invite your fellow survivors for s\'mores!', 'none');
