...
INSERT INTO `stores` VALUES ('2', 'Gander Mountain', 'www.gandermountain.com', '888-5GANDER');
INSERT INTO `stores` VALUES ('3', 'Lowe\'s', 'www.lowes.com', '336-658-4000');
INSERT INTO `stores` VALUES ('4', 'Zombies R Us', 'www.zombiesrus.com', '866-ZOMBIES');
...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES ('5', 'admin', '4f57181dcaade980555f2ce6755ca425f00658be');
...
INSERT INTO `weapons_general` VALUES ('2', 'metal pipe', 'cudgel', '10', 'Bash and smash zombie heads like your favorite plumber!', 'none');
INSERT INTO `weapons_general` VALUES ('3', 'katana', 'blade', '5', 'A daintier alternative to the machete. Slice and dice your zombies ninja style!', 'sharpening');
INSERT INTO `weapons_general` VALUES ('4', 'chainsaw', 'blade', '3', 'An unwieldy but effective means of tearing up the undead. Also potentially useful for building shelters.', 'greasing, refueling, replacing chains');
INSERT INTO `weapons_general` VALUES ('5', 'axe', 'blade', '8', 'For chopping and lopping zombie bits. A generally handy survival tool.', 'sharpening');
INSERT INTO `weapons_general` VALUES ('6', 'grenade', 'explosive', '1', 'Fire in the hole! Just pull the pin and you\'re done!', 'none');
INSERT INTO `weapons_general` VALUES ('7', 'molotov cocktail', 'explosive', '1', 'Do you like your zombies well-done? Invite your fellow survivors for s\'mores!', 'none');

-- ----------------------------
-- Table structure for `weapon_firearm_preferences`
-- ----------------------------
DROP TABLE IF EXISTS `weapon_firearm_preferences`;
...
-- ----------------------------
-- Records of weapon_firearm_preferences
-- ----------------------------

-- ----------------------------
-- Table structure for `weapon_preferences`
-- ----------------------------
DROP TABLE IF EXISTS `weapon_preferences`;
...
INSERT INTO `z_books` VALUES ('2', '978-0060931841', 'World War Z: An Oral History of the Zombie War', null, null, '352', '2007', 'Zombie War Information');
INSERT INTO `z_books` VALUES ('3', '978-1402220128', 'Zombies for Zombies: Advice and Etiquette for the ', null, null, '272', '2009', 'Guide for Zombie Etiquette');
INSERT INTO `z_books` VALUES ('4', '978-1453720011', 'A Zombie Apocalypse', null, null, '70', '2010', null);
INSERT INTO `z_books` VALUES ('5', '978-0982949597', 'The Dying Times (a zombie apocalypse novel)', null, null, '282', '2010', null);
INSERT INTO `z_books` VALUES ('6', '978-0452296398', 'You Might Be a Zombie and Other Bad News: Shocking', null, null, '320', '2010', 'Zombie Identification');
INSERT INTO `z_books` VALUES ('7', '978-1449564872', 'The Zombie Survival Guide: How to Live Like a King', null, null, '128', '2009', 'Survival Guide');
INSERT INTO `z_books` VALUES ('8', '978-0307405777', 'The Zombie Survival Guide: Recorded Attacks ', null, null, '144', '2009', 'Survival Guide');

-- ----------------------------
-- Table structure for `z_book_preferences`
-- ----------------------------
DROP TABLE IF EXISTS `z_book_preferences`;
...
-- ----------------------------
DROP TABLE IF EXISTS `z_film_preferences`;
...
-- ----------------------------
DROP TABLE IF EXISTS `z_game_preferences`;
