...
--
-- Host: localhost
-- Generation Time: Apr 05, 2011 at 03:27 PM
...
(9, '978-0060931841', 'World War Z: An Oral History of the Zombie War', 1, 352, 2007, 'Zombie War Information'),
(2, '978-1402220128', 'Zombies for Zombies: Advice and Etiquette for the Living Dead', 3, 272, 2009, 'Guide for Zombie Etiquette'),
(3, '978-1453720011', 'A Zombie Apocalypse', 4, 70, 2010, 'Zombie Theory'),
(4, '978-0982949597', 'The Dying Times (a zombie apocalypse novel)', 5, 282, 2010, 'Zombie Theory'),
...
CREATE TABLE IF NOT EXISTS `z_books_authors` (
...
(4, '5 Scientific Reasons a Zombie Apocalypse', 'http://snipurl.com/246th0', 'Justify yourself to your friends!'),
